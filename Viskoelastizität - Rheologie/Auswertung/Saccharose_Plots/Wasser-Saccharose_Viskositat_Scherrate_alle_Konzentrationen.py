# -*- coding: utf-8 -*-
"""
Created on Sat Dec  3 14:51:49 2022
...
def plot(CSVNAMES):
    ...
    #----Save Figure-----------
    plt.savefig("Water_Sucrose_Viscosity_vs_Shearrate_all_Concentrations.pdf",dpi=1200)
        
if __name__ == "__main__":
    plot(['sac_00_percent','sac_10_percent','sac_20_percent','sac_40_percent'])