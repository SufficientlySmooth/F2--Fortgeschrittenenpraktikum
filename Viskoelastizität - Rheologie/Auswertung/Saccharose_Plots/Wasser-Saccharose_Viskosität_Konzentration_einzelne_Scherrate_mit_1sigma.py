# -*- coding: utf-8 -*-
"""
Created on Sat Dec  3 16:19:37 2022
...
def plot(CSVNAMES,ind_to_be_plotted):
    ...
    for shear_ind in range(0,11):
       ...
       #------Adding the fitted lines and the measurements to figure and axis--------
        ...
        if shear_ind == ind_to_be_plotted:
    ...
    ax.errorbar(x=x_excl[ind_to_be_plotted],y=y_excl[ind_to_be_plotted],marker='x', color = 'red',linestyle='None',label='von Fit ausgeschlossen')
    ...
    #----Save Figure-----------
    plt.savefig('Viscosity_by_Concentration_Sucrose_gamma_'+str(gammadotList[ind_to_be_plotted])+'_s-1.pdf',dpi=1200)
        
if __name__ == "__main__":
    for i in range(0,11):
        plot(['sac_00_percent','sac_10_percent','sac_20_percent'],i)