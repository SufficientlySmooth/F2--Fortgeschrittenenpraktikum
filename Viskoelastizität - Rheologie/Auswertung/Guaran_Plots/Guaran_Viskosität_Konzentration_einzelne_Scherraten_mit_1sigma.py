# -*- coding: utf-8 -*-
"""
Created on Sat Dec  3 15:55:59 2022
...
def plot(CSVNAMES,ind_to_be_plottet):
    global cellcand
    ...
    for shear_ind in range(0,11):
        ...
        if shear_ind == ind_to_be_plottet:
    ...
    #----Save Figure-----------
    plt.savefig('Viscosity_by_Concentration_Guar_'+str(gammadotList[ind_to_be_plottet])+'s-1.pdf',dpi=1200)
        
if __name__ == "__main__":
    for i in range(0,11):
        plot(['guar_00000_percent','guar_00025_percent','guar_00050_percent','guar_00100_percent','guar_00140_percent','guar_00200_percent','guar_00230_percent'],i)